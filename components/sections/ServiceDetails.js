					...
					<div className="row">
						<div className="col-xl-4 col-lg-4">
							<div className="service-sidebar">
								...
								<div className="sidebar-widget banner-widget">
								  <div className="widget-content" style={{ backgroundImage: 'url(images/background/4.jpg)' }} >
									...
									<div className="content-box">
									  ...
									  <Link href="page-contact" className="theme-btn btn-sm btn-style-one light-bg"><span className="btn-title"> Contact us</span></Link>
									</div>
								  </div>
								</div>
						...
						<div className="col-xl-8 col-lg-8">
							<div className="services-details__content">
								<img src="/images/resource/service-details.jpg" title='Amiso' />
